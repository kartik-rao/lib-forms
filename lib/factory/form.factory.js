...
var FormFactory = /** @class */ (function () {
    ...
    FormFactory.createForm = function (data) {
        ...
        form.formLayoutOptions = {
            wrapperSpan: ai_core_forms_1.valueOrDefault(flOptions.wrapperSpan, 20),
            wrapperOffset: ai_core_forms_1.valueOrDefault(flOptions.wrapperOffset, 2),
            showPageBorders: ai_core_forms_1.valueOrDefault(flOptions.showPageBorders, true),
            showSectionBorders: ai_core_forms_1.valueOrDefault(flOptions.showSectionBorders, true),
            showPageTitles: ai_core_forms_1.valueOrDefault(flOptions.showPageTitles, true),
            showSectionTitles: ai_core_forms_1.valueOrDefault(flOptions.showSectionTitles, true),
            showSteps: ai_core_forms_1.valueOrDefault(flOptions.showSteps, true),
            validationDisablesPaging: ai_core_forms_1.valueOrDefault(flOptions.validationDisablesPaging, true),
        };
        var tenant = {};
        if (data.tenant) {
