...
var FormComponent = /** @class */ (function (_super) {
    ...
    FormComponent.prototype.render = function () {
        var _this = this;
        var _a = this.props.formLayoutOptions, showPageTitles = _a.showPageTitles, showSteps = _a.showSteps;
        return (React.createElement("div", { className: "form-wrapper" },
            this.props.content.title &&
                React.createElement(antd_1.Card, null,
                    React.createElement("h2", null, this.props.content.title),
                    React.createElement("br", null),
                    React.createElement("h3", null, this.props.content.subtitle)),
                                ...
                                React.createElement(antd_1.Card, null,
                                    React.createElement(antd_1.Row, null,
                                        React.createElement(antd_1.Col, { span: 24, style: { textAlign: 'right' } },
                                            ...
                                            currentPage < numPages - 1 && React.createElement(antd_1.Button, { type: "primary", style: { marginLeft: 8 }, className: "action-button", onClick: function () { return _this.next(); } }, "Next"),
                                            currentPage == numPages - 1 && React.createElement(antd_1.Button, { type: "primary", style: { marginLeft: 8 }, htmlType: "submit", className: "action-button" }, "Submit"))))));
                    }))))));
    };
