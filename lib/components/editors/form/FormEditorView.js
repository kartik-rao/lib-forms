...
let FormEditorView = class FormEditorView extends React.Component {
    render() {
        ...
        return form && React.createElement(Drawer, { title: `Form "${form.name}" `, onClose: () => store.setFormEditorVisible(false), visible: store.showFormEditor == true, width: 700, style: { overflow: 'hidden' } }, React.createElement(Tabs, { size: "small" },
