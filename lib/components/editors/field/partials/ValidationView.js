    ...
    render() {
        ...
        return React.createElement("div", null,
            React.createElement(Card, { size: "small", bodyStyle: { padding: '0' }, actions: [React.createElement("span", { style: { visibility: availableRules.length > 0 ? 'visible' : 'hidden' } },
                        React.createElement(Button, { size: "small", onClick: () => this.setIsAdding(true) }, "Add"))] },
                ...
                !!hasValidation && React.createElement(ValidationListView, { validation: field.validator.rule, onEdit: this.onEdit, onRemove: store.removeValidationRule })),
            (this.isAdding || this.isEditing) && React.createElement(Card, { size: "small", bodyStyle: { padding: '8px' }, style: { marginTop: '15px' }, title: `${this.isEditing == true ? "Edit" : "Add"} Rule ${this.ruleType ? ' - ' + this.ruleType : ''}` },
                React.createElement(Form, Object.assign({ layout: "horizontal" }, formItemLayout),
                    ...
                    React.createElement(Form.Item, Object.assign({}, tailFormItemLayout, { style: { marginTop: '15px' } }),
                        React.createElement(Button, { style: { marginRight: '10px' }, type: "primary", htmlType: "submit", size: "small", disabled: !this.isRuleValid, onClick: this.applyRule }, this.isEditing == true ? "Apply" : "Add"),
