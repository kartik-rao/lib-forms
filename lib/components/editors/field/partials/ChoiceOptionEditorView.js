    ...
    render() {
        ...
        return React.createElement(Card, { size: "small", bodyStyle: { padding: 0 }, bordered: false },
            ...
            this.items.length > 0 && React.createElement(ReactDragListView, { onDragEnd: this.move, handleSelector: "i", nodeSelector: "tr.ant-table-row" },
                React.createElement(Table, { size: "small", pagination: rows.length > 5 ? { position: 'bottom' } : false, dataSource: rows, columns: columns, rowKey: 'key', footer: () => this.showAdd ? React.createElement(React.Fragment, null) : React.createElement(Button, { size: "small", onClick: (e) => this.showAddChoiceItem(true) }, "Add") })),
            this.showAdd && React.createElement(Card, { title: "Add option", size: "small", style: { marginTop: '15px' } },
                React.createElement(Form, Object.assign({}, formItemLayout, { layout: "horizontal", onSubmit: (e) => this.addChoiceOption(e) }),
                    React.createElement(Form.Item, { help: "Enter the label shown to the user (must be unique)", label: "Label" }, getFieldDecorator('label', {
                        valuePropName: 'label',
                        rules: [
                            { type: 'string' },
                    ...
                    React.createElement(Form.Item, { help: "Enter the value that will be submitted (must be unique)", label: "Value" }, getFieldDecorator('value', {
                        valuePropName: 'value',
                        rules: [{ type: 'string' },
                    ...
                    React.createElement(Form.Item, Object.assign({}, tailFormItemLayout),
                        React.createElement(Button, { type: "danger", style: { marginRight: '15px' }, onClick: () => this.showAddChoiceItem(false) }, "Cancel"),
...
const WrappedChoiceOptionEditorView = Form.create({ name: 'ChoiceOptionEditorView' })(ChoiceOptionEditorView);
