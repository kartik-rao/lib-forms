...
const ChoiceOptionEditorView = (props) => {
    ...
    return useObserver(() => {
        return React.createElement(Card, { size: "small", bodyStyle: { padding: 0 }, extra: React.createElement(Button, { disabled: !localStore.isDirty, onClick: localStore.onApply, size: "small", type: "primary" }, "Save") },
            React.createElement(ReactDragListView, { onDragEnd: localStore.move, handleSelector: "i", nodeSelector: "tr.ant-table-row" },
                React.createElement(Table, { size: "small", bordered: false, pagination: localStore.rows.length > 5 ? { position: 'bottom' } : false, dataSource: localStore.rows, columns: columns, rowKey: 'key', footer: () => localStore.showAdd ? React.createElement(React.Fragment, null) : React.createElement(Button, { size: "small", onClick: (e) => localStore.showAddChoiceItem(true) }, "Add") })),
            localStore.showAdd && React.createElement(Card, { title: "Add option", size: "small", style: { marginTop: '15px' } },
                React.createElement(Form, Object.assign({}, formItemLayout, { layout: "horizontal", onSubmit: (e) => localStore.addChoiceOption(e) }),
                    ...
                    React.createElement(Form.Item, Object.assign({}, tailFormItemLayout),
                        React.createElement(Button, { type: "danger", size: "small", style: { marginRight: '15px' }, onClick: () => localStore.showAddChoiceItem(false) }, "Cancel"),
                        React.createElement(Button, { type: "primary", size: "small", htmlType: "submit" }, localStore.isEditing ? "Save" : "Add")))));
    });
};
