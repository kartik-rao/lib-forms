...
export const SectionLayoutPreview = (props) => {
    return React.createElement(Card, { title: "Preview", size: "small", bordered: false },
        React.createElement(Row, { className: "fl-layout-demo-row", gutter: props.gutter }, props.colspans.map((span, ci) => {
...
// export class SectionLayoutPreviewOld extends React.Component<ISectionLayoutPreviewProps, any>{
