    ...
    return useObserver(() => {
        return React.createElement(Layout, { className: "fl-full-height-nopad" },
            React.createElement(Menu, { mode: "horizontal", theme: "light", multiple: true, className: "fl-shadow-sides" },
                ...
                React.createElement(Menu.Item, { title: "Save", onClick: localStore.onSave, key: "save" },
                    React.createElement(Icon, { theme: 'filled', type: "save" }))),
            React.createElement(Layout.Content, null,
                React.createElement(DragDropContext, { onDragEnd: localStore.onDragEnd },
                    React.createElement(Layout, { className: "fl-full-height-nopad" },
                        React.createElement(Layout.Sider, { trigger: null, collapsed: localStore.siderCollapsed, style: { zIndex: 11, background: '#FFFF' }, collapsible: true, onCollapse: localStore.onSiderCollapse, theme: "light", collapsedWidth: 0 },
                        ...
                        React.createElement(Content, { style: { overflow: "hidden", padding: '0' } },
                            ...
                            React.createElement(Col, { span: 16, style: { height: '100%' } },
                                React.createElement(Layout, { style: { height: "100%" } },
                                    React.createElement(Layout.Content, null,
                                        React.createElement(Card, { bordered: false, title: "Preview", style: { width: "100%", padding: '1px', borderBottom: '1px' }, bodyStyle: { padding: 0 } }),
                                        React.createElement("div", { className: "fl-shadow-sides fl-full-height", style: { backgroundColor: "white", overflow: "auto", paddingBottom: '65px' } },
                                            React.createElement(FormStoreProvider, { formStore: store.formStore }, localStore.hasContent ? React.createElement(FormView, { style: { height: "100%" } }) :
