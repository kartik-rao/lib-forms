...
var FormFactory = /** @class */ (function (_super) {
    ...
    FormFactory.prototype.render = function () {
        var _a = this.props, initialState = _a.initialState, rest = __rest(_a, ["initialState"]);
        var form = this.state.form;
        return (React.createElement("form", __assign({}, this.props.form.props), this.props.fields.map(function (f, i) {
            var Field = f.element;
            var props = f.props;
            switch (f.element) {
                case "input":
                    return React.createElement("input", __assign({ key: i }, props));
                case "select":
                    return React.createElement("select", __assign({ key: i }, props), props.options.map(function (o, oi) {
                        return React.createElement("option", __assign({ key: oi }, o.props), o.text || '');
                    }));
                case "textarea":
                    return React.createElement("textarea", __assign({ key: i }, f.props), f.text || '');
            }
        })));
    };
    return FormFactory;
